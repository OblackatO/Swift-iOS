...
//:
class Shape {
    let numberOfCorners : String = "hello"
    var numberOfSides = 0
    func simpleDescription() -> String {
        return "A shape with \(numberOfSides) sides, and \(numberOfCorners)."
    }
    
    /*
    func tosaysomething(word_to_say : String) -> String  {
        return "I just said:\(word_to_say)"
    }
    */
...
test.simpleDescription()
    ...
    class Circle : NamedShape {
        ...
        func area() -> Double  {
            return 2.0 * 3.14 * (self.radius/2)*(self.radius/2)
        }
//: - Experiment:
